...
img: aiml_week01.jpg # Add image post (optional)

abcd_title: Core Concepts in Machine Learning Part 1
abcd_video: https://www.youtube.com/embed/3a544HgaSfU
abcd_slides: https://docs.google.com/presentation/d/1UWifBI6DM52WFSoYwtdt5JbQ-crbOrArLJDxAPsfu8M/edit?usp=sharing
abcd_reading_links: ["https://scikit-learn.org/stable/modules/linear_model.html#ridge-regression-and-classification", "https://scikit-learn.org/stable/modules/cross_validation.html#cross-validation", "https://youtu.be/jGwO_UgTS7I?t=2399", "https://www.youtube.com/watch?v=u73PU6Qwl1I"]
abcd_reading_names: [1. Linear models in scikit learn, 2. Cross-validation in scikit learn, 3. In-depth lecture on supervised learning with linear regression (time-stamped video @ 40mins), 4. Detailed explanation of model regularization]

repronim_title: Core Concepts in Machine Learning Part 2
repronim_video: https://www.youtube.com/embed/c9ayKFSt_Ek
repronim_slides: https://drive.google.com/file/d/1T1PAJ_ovM5YAVb3Z7paIGb2-_i7OQY0g/view?usp=sharing
repronim_reading_links: ["https://hastie.su.domains/ISLR2/ISLRv2_website.pdf"]
repronim_reading_names: ["Chapters 2.1 and 2.2 of 'An Introduction to Statistical
Learning' by Gareth James, Daniela Witten, Trevor Hastie, and Robert Tibshirani (available for free online)"]
...
**Welcome AI/ML Course Students!**: The [AI/ML Course](https://www.abcd-repronim.org/ml.html) is a standalone event that is available in addition to the [12-week ABCD-ReproNim Main Course](https://www.abcd-repronim.org/). If you would like to take the AI/ML Course then please make sure to register [here](https://bit.ly/ABCD-ReproNim-Register) so we can add you to our AI/ML Course email list! Please note: we recommend that students first complete the main 12-week Course before beginning the 5-week AI/ML Course. AI/ML Course materials will be updated weekly and will remain online indefinitely.

**Week 1 AI/ML Data Exercise**: Each week we will ask AI/ML Course students to complete a [Data Exercise](https://github.com/ABCD-ReproNim/exercises-ML/blob/main/week_1/Week1%20Problems.ipynb) that asks questions about the week's lectures. *Please complete the Week 1 AI/ML Data Exercise after viewing the Week 1 AI/ML videos.* Solutions for this week's data exercise can be found on our [GitHub](https://github.com/ABCD-ReproNim/exercises-ML/blob/main/week_1/Week1%20Solutions.ipynb)

**ABCD Data Access Confirmation**: AI/ML Course students who wish to take part in the ABCD-ReproNim Project Month (April 4 - 29, 2022) will need access to ABCD Study data. To do so you will need to obtain a Data Use Certification (DUC) from the [NDA](https://nda.nih.gov/). We provide instructions on [how to obtain ABCD data access](https://docs.google.com/document/d/18hsT2x15bypuXFcfMQb9Ck_YEB7VvY2j4w5hwbV78A4/edit?usp=sharing) to help with this process. Once you have an approved DUC please complete our [ABCD Data Access Confirmation](https://docs.google.com/forms/d/e/1FAIpQLSdZbXLB2HdciB88YN3JIXg6OdUN2dq1KnLTolIcos2Tu6FazA/viewform?usp=sf_link). Note that you do not need to have ABCD data access in order to take the AI/ML Course. This assignment is optional and does not count towards completion of the course. However, *students who do not successfully complete this assignment will not be allowed to participate in Project Month.*
