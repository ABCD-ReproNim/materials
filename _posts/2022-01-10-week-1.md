...
header-text: Week 1 Lectures: Drs. Angie Laird and David Kennedy introduce the ABCD-ReproNim Course, the ABCD Study, and ReproNim: A Center for Reproducible Neuroimaging Computation.
...
---
**Pre-Course Survey**: We would like for all students to complete a Pre-Course Survey so that we will have metrics with which to measure our success at the conclusion of ABCD-ReproNim. **Please complete the Pre-Course Survey before viewing the Week 1 videos.**
