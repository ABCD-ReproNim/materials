...
assignment_names: ["AI/ML Pre-Course Survey -- please complete if you are new to the course!", "AI/ML Week 2 Data Exercise (Jupyter notebook version)", "AI/ML Week 2 Data Exercise Submission Form", "ABCD Data Access Confirmation (this assignment is optional and we will re-post it each week until April 1, 2022 -- please complete it if you plan to participate in Project Month)"]
qa_video:
---
