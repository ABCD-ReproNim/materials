...
**ABCD-ReproNim JupyterHub Access Request**: We are thrilled to provides students with active NDA Data Use Certification access to the new [ABCD-ReproNim JupyterHub](https://abcd.repronim.org/), a cloud-based scientific computing platform that is fully accessible through an internet browser (see [this link](https://jupyter.org/hub) for details about the JupyterHub project!) [This document](https://docs.google.com/document/d/1kXvK2c_N9TkIAYn21WfzlCPtJvxhjW13Ftf0DwnAnlg/edit?usp=sharing) introduces the [ABCD-ReproNim JupyterHub](https://abcd.repronim.org/) and discusses how to use it. The [ABCD-ReproNim JupyterHub](https://abcd.repronim.org/) is a platform on which students can work on Data Exercises and perform analyses of ABCD data projects during Project Month.

ABCD-ReproNim staff will grant access to students who 1) complete the [ABCD Data Access Confirmation](https://docs.google.com/forms/d/e/1FAIpQLSdZbXLB2HdciB88YN3JIXg6OdUN2dq1KnLTolIcos2Tu6FazA/viewform?usp=sf_link) assignment, and 2) submit a [ABCD-ReproNim JupyterHub Access Request](https://docs.google.com/forms/d/e/1FAIpQLSefrxRzdjFak_BoxTL5bE-TnsJdg9KbGvFdOwuW7zliZ96z7g/viewform?usp=sf_link) with your GitHub username. If you do not already have a GitHub username you can sign up for one [here](https://github.com/join). Students without an active NDA Data Use Certification can follow the instructions [here]](https://neurostars.org/t/using-abcd-repronim-jupyterhub-container-locally-via-docker). Learn more about the [ABCD-ReproNim JupyterHub](https://abcd.repronim.org/) [here](https://docs.google.com/document/d/1kXvK2c_N9TkIAYn21WfzlCPtJvxhjW13Ftf0DwnAnlg/edit?usp=sharing)!
