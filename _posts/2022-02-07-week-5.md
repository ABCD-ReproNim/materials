...
**ABCD-ReproNim JupyterHub Access Request**: We are please to provides students with current NDA DUCs access to a common cloud-based computational platform for performing course-related data exercises, known as a "JupyterHub" (see [this link](https://jupyter.org/hub) for details about the JupyterHub project!) This environment will also be used during Project Month but will be powered down soon thereafter. In order to access the [ABCD-ReproNim JupyterHub](https://abcd.repronim.org/) you will need to 1) complete the [ABCD Data Access Confirmation](https://docs.google.com/forms/d/e/1FAIpQLSdZbXLB2HdciB88YN3JIXg6OdUN2dq1KnLTolIcos2Tu6FazA/viewform?usp=sf_link) assignment described above, and 2) submit a [ABCD-ReproNim JupyterHub Access Request](https://docs.google.com/forms/d/e/1FAIpQLSefrxRzdjFak_BoxTL5bE-TnsJdg9KbGvFdOwuW7zliZ96z7g/viewform?usp=sf_link) with your GitHub username. If you do not already have a GitHub username you can sign up for one [here](https://github.com/join). Learn more about the [ABCD-ReproNim JupyterHub](https://abcd.repronim.org/) [here](https://docs.google.com/document/d/1kXvK2c_N9TkIAYn21WfzlCPtJvxhjW13Ftf0DwnAnlg/edit?usp=sharing)!
